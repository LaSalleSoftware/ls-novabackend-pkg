...
/**
 * Class Installed_domains_jwt_key
 *
 * @package Lasallesoftware\Novabackend\Nova\Resources\Installed_domains_jwt_key
 */
class Installed_domains_jwt_key extends BaseResource
{
    /**
