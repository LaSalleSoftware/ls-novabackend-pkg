...
class Lookup_social_type extends BaseResource
{
     ...
     * @var string
     */
    public static $model = 'Lasallesoftware\\Librarybackend\\Profiles\\Models\\Lookup_social_type';
    ...
    {
        return __('lasallesoftwarelibrarybackend::general.resource_label_plural_lookup_social_types');
    }
    ...
    {
        return __('lasallesoftwarelibrarybackend::general.resource_label_singular_lookup_social_types');
    }
