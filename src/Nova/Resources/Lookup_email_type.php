...
class Lookup_email_type extends BaseResource
{
     ...
     * @var string
     */
    public static $model = 'Lasallesoftware\\Library\\Profiles\\Models\\Lookup_email_type';
    ...
    {
        return __('lasallesoftwarelibrary::general.resource_label_plural_lookup_email_types');
    }
    ...
    {
        return __('lasallesoftwarelibrary::general.resource_label_singular_lookup_email_types');
    }
