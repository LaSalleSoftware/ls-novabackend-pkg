 ...
 */
class Lookup_email_type extends BaseResource
{
    /**
     ...
     * @var string
     */
    public static $model = 'Lasallesoftware\\Librarybackend\\Profiles\\Models\\Lookup_email_type';
    ...
    {
        return __('lasallesoftwarelibrarybackend::general.resource_label_plural_lookup_email_types');
    }
    ...
    {
        return __('lasallesoftwarelibrarybackend::general.resource_label_singular_lookup_email_types');
    }
    ...
    public function fields(Request $request)
    {
        return [
            ...
            LookupTitle::make('title')
                ->creationRules('unique:lookup_email_types,title')
                ->updateRules('unique:lookup_email_types,title,{{resourceId}}'),
