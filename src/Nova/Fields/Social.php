 ...
 */
class Social extends BaseTextField
{
    /**
    ...
    public function __construct($name, $attribute = null, $resolveCallback = null)
    {
        ...
        $this->name = __('lasallesoftwarelibrarybackend::general.field_name_social');
        ...
        $this->creationRules('required', 'unique:socials,url');
        $this->updateRules('required', 'unique:socials,url,{{resourceId}}');
    }
